...
Thanks. We separated the remaining customers to the bottom panel with points of some transparency. We have kept the line range plot instead of a histogram. Because the range plot is more informative: individual missings are congregated between January and March with sporadic continuous missings over the rest of the year.
