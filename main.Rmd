...
The tidy data abstraction lays the foundation for data science modules including transformation, visualisation and modelling. Each module frictionlessly communicates between each other. Because a desirable toolbox acquires tidy input, produces tidy output, and consequently chains a series of operations together to accomplish analytic tasks at hand.
