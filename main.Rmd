...
In SQL database, a primary key [@codd_relational_1970], which uniquely defines each record in a database table, is equivalent to the composition of "index" and "key". 
