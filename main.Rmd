...
@eopl assert "No matter how complex and polished the individual operations are, it is often the quality of the glue that most directly determines the power of the system." Each verb works with other transformation family members in harmony. The chaining of manipulation verbs prepares tsibble for visualization and modeling in numerous ways. Most importantly, the ecosystem for tidy time series analysis has been undertaking on the basis of tsibble in R, know as "tidyverts".

As a special case of tabular data, a tsibble pipes into the grammar of graphics straight way, making most use of existing graphical toolkits. Specialist plotting.
