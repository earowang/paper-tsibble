...
\multirow{4}{*}{Reshape data} & \textbf{\texttt{gather()}} & David Batty \\
 ...
 & \textbf{\texttt{unnest()}} & Jody Morris \\
\bottomrule
\end{tabular}
\end{table}
