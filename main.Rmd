...
A pipeline exhibits a hierarchy of data operations: (1) atomic (1-dimensional) vectors (`mean(variale)`) --> (2) (2-dimensional) data table (`summarise()`) --> repeat step (1) and (2) to form a chain.
