...
\multirow{3}{*}{Time gaps} & \texttt{has\_gaps()} & Test if a tsibble has gaps in time \\
 & \texttt{count\_gaps()} & Count and report time gaps \\
...
# Software structure and design decisions
