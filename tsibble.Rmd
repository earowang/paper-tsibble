...
(ref:elec-forecast-cap) One-day (48 step ahead) forecasts generated by ARIMA models, with and without temperatures, plotted against the actual demand. Both nicely capture the temporal dynamics, but ARIMA with temperature performs better than the model without.
