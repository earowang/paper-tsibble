...
Lastly, a common practice in the energy sector is load forecasting. Forecasting the demand for the last day of 2013 is undertaken, holding the original energy data as the validation set. The most recent December data is fitted by ARIMA models with and without temperature information using automatic order selection [@autoarima]. The logarithmic transformation is applied to the average demand to ensure the positive forecasts. Figure \@ref(fig:elec-forecast) plots the one-day forecasts obtained from both models against the actual demand within the last week window. ARIMA regressed by average temperatures gives a better fit than the one without, although both tend to underestimate the night demand. The forecasting performance is reported in Table \@ref(tab:elec-accuracy), consistent with the findings in Figure \@ref(fig:elec-forecast).
...
(ref:elec-forecast-cap) One-day forecasts generated by ARIMA models with and without temperatures plotted against the actual demand. Both nicely capture the temporal dynamics, but ARIMA with temperatures performs better than the one without.
