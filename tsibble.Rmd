...
Despite this variety and heterogeneity of temporal data, the lack of a uniform data organization expects analysts to do their own data preprocessing and take care of anything else needed to allow further analysis, which leads to a myriad of ad hoc solutions and duplicated efforts.

@r4ds proposed the tidy data workflow, which provides a conceptual framework for exploring data (as described in Figure \@ref(fig:tsibble-fit)). In temporal domain, data with temporal information arrives at the "import" stage. A new abstraction, *tsibble*, is the gatekeeper at the "tidy" stage, to verify if the raw temporal data is appropriate for downstream analytics. The exploration loop will be aided with declarative grammars for more robust and accurate analysis.
