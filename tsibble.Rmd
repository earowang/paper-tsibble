...
These verbs are evocative and of simple interface. They by default look into gaps for each individual time period. Switching on the option `.full = TRUE` will fill in the full-length time span, creating fully balanced panels with respect to longitudinal data analysis.
