...
This paper describes a new uniform representation for time series and longitudinal data, and a unified framework to streamline the workflow from data preprocessing to visualization and forecasting, as an integral part of a tidy data analysis.
