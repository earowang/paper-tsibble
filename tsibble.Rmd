...
Figure \@ref(fig:tsibble-semantics) sketches out the data form required for a tsibble, the same format as the "tidy data". Beyond the layout, tsibble gives the contextual meaning to variables in order to construct the temporal data object, as newly introduced "index" and "key" semantics stated in 1 and 2 above. As a result of the definitions 3 and 4, tsibble is *tidier* than "tidy data", placing itself as a data object that is also suitable for modeling.
